    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Embarking on the language journey, learning greetings and essential words.", 100, "Wanderer" },
                    { 2, "Navigating simple conversations and discovering basic grammar structures.", 200, "Explorer" },
                    { 3, "Confidently sharing stories and engaging in daily discussions.", 400, "Storyteller" },
                    { 4, "Mastering complex topics, idioms, and nuanced expressions.", 600, "Sage" },
                    { 5, "Achieving legendary fluency and cultural mastery, speaking like a native.", 1000, "Polyglot" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Discriminator", "Email", "FirstName", "IsActive", "IsEmailVerified", "LastName", "PasswordHash", "PasswordSalt", "RoleId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 10, 14, 33, 45, 734, DateTimeKind.Utc).AddTicks(6475), "Admin", "admin@justspeak.com", "Admin", true, true, "User", "hashed_password", "salt", 1 },
                    { 2, new DateTime(2025, 8, 10, 14, 33, 45, 734, DateTimeKind.Utc).AddTicks(6517), "Tutor", "maria@justspeak.com", "Maria", true, true, "Garcia", "hashed_password", "salt", 2 },
                    { 3, new DateTime(2025, 8, 10, 14, 33, 45, 734, DateTimeKind.Utc).AddTicks(6522), "Tutor", "jean@justspeak.com", "Jean", true, true, "Dubois", "hashed_password", "salt", 2 },
                    { 4, new DateTime(2025, 8, 10, 14, 33, 45, 734, DateTimeKind.Utc).AddTicks(6551), "Student", "hans@justspeak.com", "Hans", true, true, "Muller", "hashed_password", "salt", 3 },
                    { 5, new DateTime(2025, 8, 10, 14, 33, 45, 734, DateTimeKind.Utc).AddTicks(6555), "Student", "yuki@justspeak.com", "Yuki", true, true, "Tanaka", "hashed_password", "salt", 3 }
                });
